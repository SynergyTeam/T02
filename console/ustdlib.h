...
extern char *ustrcpy(char *restrict s1, const char *restrict s2);
extern char *ustrncpy(char * restrict s1, const char * restrict s2, size_t n);
extern char *ustrcat(char *restrict s1, const char *restrict s2);
extern char *ustrncat(char *restrict s1, const char *restrict s2, int n);
